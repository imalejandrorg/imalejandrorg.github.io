...
\begin{equation}
r(s_y/s_x) = 0.9437 \times (35.3/4.6) = 7.242
\end{equation}

Lo que equivale a un cambio de 7.242 g/cm. Es decir que un incremento en la longitud de una serpiente de 1 cm trae consigo un aumento en su peso de cerca de 7.242 g. Usando estos valores podemos encontrar el intercepto de $Y$.

\begin{equation}
b_0 = 152 - 7.242 \times 4.6 = 118.6868
\end{equation}

Por ende, nuestra línea de regresión ajustada es $\hat{y} = 118.6868 - 7.242x$.
