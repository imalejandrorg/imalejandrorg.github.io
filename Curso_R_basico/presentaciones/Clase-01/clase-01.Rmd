...
knitr::include_graphics("O:/Tesis/R/Webpage/imalejandrorg.github.io/Curso_R_basico/images/DataType.png", dpi = 120)
```
...
```{r echo=FALSE, fig.align="center", message=FALSE, warning=FALSE, paged.print=FALSE}
knitr::include_graphics("O:/Tesis/R/Webpage/imalejandrorg.github.io/Curso_R_basico/images/Package1.png", dpi = 120)
```
...
```{r echo=TRUE}
Aves <- read.table("O:/Tesis/R/Webpage/imalejandrorg.github.io/Curso_R_basico/Aves.txt",
                   header = TRUE)
View(Aves)
```
...
```{r echo=TRUE}
Aves_csv <- read.csv("O:/Tesis/R/Webpage/imalejandrorg.github.io/Curso_R_basico/Aves.csv", header = TRUE)

library(readxl)
Aves_xlsx <- read_excel("O:/Tesis/R/Webpage/imalejandrorg.github.io/Curso_R_basico/Aves.xlsx")
```
