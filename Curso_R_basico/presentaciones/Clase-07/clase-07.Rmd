...
## Correlación y regresión lineal {.build}
...
## La anfetamina y el apetito {.build .smaller}
...
## La anfetamina y el apetito {.build}

A continuación tenemos una **gráfica de dispersión** con los valores de la tabla.

```{r anf2, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center'}
...
## Coeficiente de correlación $r$ {.build}
...
## Gráfico de dispersión {.build}

```{r snake2, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center', fig.height=5, fig.width=5}
...
```{r snake3, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center', fig.height=5, fig.width=5}
...
## Fundamento del coeficiente de correlación {.build}
...
## Modelo de muestreo aleatorio bivariado {.build}
...
## Inferencias acerca de la correlación {.build}
...
## Intervalo de confianza para $\rho$ {.build}
...
## La línea de cuadrados mínimos {.build}
...
## Ecuación de la regresión lineal {.build}
...
## El caso de las serpientes {.build}
...
## Gráfico de promedios {.build .smaller}
...
## Línea de regresión suavizada {.build}
...
## Suavizado para los datos de las ratas {.build}
...
```{r resid, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center', fig.height=5, fig.width=5}
Longitud <- c(60, 69, 66, 64, 54, 67, 59, 65, 63)
Peso <- c(136, 198, 194, 140, 93, 172, 116, 174, 145)
Serpientes <- data.frame(Longitud, Peso)
...
## Suma de cuadrados de los residuales {.build}
...
## Residuales para las serpientes {.build}
...
## Criterio de mínimos cuadrados {.build}
...
## Desviación estándar de los residuales {.build .smaller}
...
## Creando nuestro modelo lineal {.build .smaller}
...
## Obtener los valores predichos {.build}
...
## Coeficiente de determinación {.build}
...
## Coeficiente de determinación para serpientes {.build}
...
## El caso de las ratas y las anfetaminas {.build}
...
## Condiciones del modelo lineal {.build}
...
## Modelo de submuestreo aleatorio {.build}
...
## Estmiaciones del modelo lineal {.build}
...
## Interpolación con el modelo lineal {.build}
...
## Interpolación vs extrapolación {.build}
...
## El caso de las serpientes... again {.build}
...
## Inferencia estadística respecto de $\beta_1$ {.build}
...
## El error estándar de $b_1$ {.build}
...
## Intervalo de confianza para $\beta_1$ {.build}
...
## Prueba de hipótesis para $H_0: \beta_1 = 0$ {.build}
...
## La función summary() {.build .smaller}
...
```{r resplot, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align="center", fig.width=5, fig.height=4}
...
```{r resplot2, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center', fig.width=4, fig.height=4}
library(ggpubr)
ggqqplot(Serpientes$Residuales, conf.int.level = 0.0, xlab = "Valores Z", ylab = "Residuales", ggtheme = theme_classic())
```

## Intervalos de confianza y predicción {.build}
...
## Computando los intervalos {.build}
...
## Computando los intervalos {.build .smaller}
...
```{r confypred, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center', fig.height=4, fig.width=5}
