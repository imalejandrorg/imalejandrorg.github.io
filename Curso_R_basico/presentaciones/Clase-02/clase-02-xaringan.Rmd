...
.panelset[
.panel[.panel-name[Variables continuas]
...
.panel[.panel-name[Variables categóricas]
...
.panel[.panel-name[Observaciones impares]
...
```{r echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=5.1, fig.width=10}
ggplot(data.frame(x), aes(x)) +
