...
Mientras que para obtener la desviación estándar agrupada simplemente obtenemos la raíz cuadrada.
...
---
# Funciones de la distribución de $F$
...
knitr::include_graphics("tabla1.png", dpi = 120)
```
...
---
### SS(bloques) para variedades de semillas
...
### MS(bloques) para variedades de semillas
...
---
### SS(total) para variedades de semillas
...
### SS(dentro) para variedades de semillas
...
---
### MS(dentro) para variedades de semillas
...
### Estadístico de $F$ para variedades de semillas
...
Simplemente añadimos `+ Bloque` después del tratamiento en el argumento de la función `aov()`. El valor p obtenido es de 0.320294, aceptamos la $H_0$. Las cuatro variedades tienen el mismo rendimiento. ¡Observemos la cantidad de variabilidad explicada por $SS(bloques)$!
...
### Cantidad de luz y estrés en plantas
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center'}
knitr::include_graphics("tabla2.png", dpi = 100)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center'}
knitr::include_graphics("tabla3.png", dpi = 110)
```
...
---
# Modelo de ANOVA con interacciones
...
---
# Agregando el efecto de la interacción
...
---
# Error estándar de la combinación lineal
...
---
## Intervalo de confianza para la combinación lineal
...
---
## Intervalo de confianza para los datos de la soya
...
Estamos 95% seguros de que el efecto del estrés, promediado sobre las condiciones de luz, es reducir el área de la hoja de las plantas por una cantidad que está entre $17.15 \space cm^2$ y $50.55 \space cm^2$.
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center'}
knitr::include_graphics("tabla2.png", dpi = 80)
```
...
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center', fig.height=3.5}
