...
3. Para corroborar si nuestros cálculos son correctos la suma de $K_1$ y $K_2$ debe ser igual al producto de $n_1 * n_2$. 
...
Aves2 %>% 
  knitr::kable("html", align = c("c", "c"), caption = "Número de veces que fue dominante un ave") %>%
  kableExtra::kable_classic(lightable_options = "striped", full_width = F) %>% 
