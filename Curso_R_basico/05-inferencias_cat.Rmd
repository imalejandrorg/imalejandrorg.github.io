...
Como podemos ver, hay dos casos que corresponden a una respuesta *sí/sí* y 77 casos que corresponden a una respuesta *no/no.* Estos no nos ayudan a determinar si el VIH ocurre con mayor frecuencia en hijos menores que en mayores, y se les conoce como **pares concordantes.** Tenemos a su vez 17 casos *sí/no* y 18 *no/sí.* Estos se conocen como **pares discordantes** y nos ayudana  determinar si la infección por VIH ocurre con mayor frecuencia en uno de los dos casos (hijos mayores vs menores).
